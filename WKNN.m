function [MD_mat_new] = WKNN( MD_mat, MM_mat, DD_mat, K, r )
% WKNN preprocessing for the drug-by-disease association matrix.
...
y_md=(y_m*a1+y_d*a2)/(a1+a2);  
 ...
 for i = 1 : rows
     for j = 1 : cols
         % The elementwise max operation preserves known associations and adds WKNN-derived soft scores for unknown entries.
