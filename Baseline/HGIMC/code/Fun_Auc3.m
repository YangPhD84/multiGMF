function [ Result_Auc,Result_Max_pre,Result_AUPR ] = Fun_Auc3( R_Wdr,WdrOrg,TestIds )
...
R_m_TPRArray = [0,DresultMat_TPR];
R_m_PreArray = [1,DresultMat_Pre];
Result_AUPR = trapz(R_m_TPRArray,R_m_PreArray);
end
