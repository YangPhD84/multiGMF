...
for num = 1:p_drugLen
    ...
    %% MSBMF
    [U,V,iter,stop1,stop2]=MSBMF(P_TMat,Wdd,Wrr,lambda1,lambda2,lambda3,lambda33,lambda4,lambda44,rankk,tol1,tol2,maxiter);
    M_ResultMat=U*V';
    iter_ePos(num) = iter;
...
% Manuscript-reported AUPR point estimate and per-target-drug SD.
...
save Fdataset_STresult_MSBMF_Denovoone.mat ...
    ...
    lambda1 lambda2 lambda3 lambda33 lambda4 lambda44 ...
    numk rankk tol1 tol2 maxiter